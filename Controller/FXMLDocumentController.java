...
public class FXMLDocumentController implements Initializable {
    ...
    {
         Parent next = FXMLLoader.load(getClass().getResource("Mechaboo.fxml"));
    ...
    private void handleButtonAction(ActionEvent event) throws IOException {
        if(txt.getText().equals("jewel")&&pass.getText().equals("2022"))
        {
        ...
        al.setTitle("Error !");
        al.setContentText("ami toh vala na, vala loiyai thako ");
